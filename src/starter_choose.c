...
#define GRASS_STARTER (IS_FRLG ? SPECIES_BULBASAUR  : SPECIES_MAWILE)
#define FIRE_STARTER  (IS_FRLG ? SPECIES_CHARMANDER : SPECIES_BELDUM)
#define WATER_STARTER (IS_FRLG ? SPECIES_SQUIRTLE   : SPECIES_SKARMORY )
